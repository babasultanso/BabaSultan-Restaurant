...
export const inventoryDict = {
  ...
  so: {
    ...
    totalSuppliers: 'Wadarta Alaab-qeybiyeyaasha',
    ...
    category: 'Qaybta',
    unit: 'Halbeegga',
    purchaseCost: 'Qiimaha Iibsiga ($)',
    sellingCost: 'Qiimaha Beeca ($)',
    currentQuantity: 'Tirada Hadda',
    minimumQuantity: 'Ugu Yar',
    maximumQuantity: 'Ugu Badan',
    ...
    poPartiallyReceived: 'Qayb ahaan La Helay',
